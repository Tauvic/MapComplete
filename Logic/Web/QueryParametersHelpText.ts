...
export default class QueryParametersHelpText {
    ...
    public static GenerateQueryParameterDocs(): string {
        const docs = [QueryParametersHelpText.QueryParamDocsIntro];
    ...
    public static init(){
        window["mapcomplete_query_parameter_overview"] = () => {
            console.log(QueryParametersHelpText.GenerateQueryParameterDocs())
        }
    }
}